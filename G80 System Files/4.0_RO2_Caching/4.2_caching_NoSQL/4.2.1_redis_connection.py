...
REDIS_HOST = 'redis-18745.c267.us-east-1-4.ec2.cloud.redislabs.com'  # Replace with your Redis Cloud host
REDIS_PORT = 18745                                                    # Replace with your Redis Cloud port
REDIS_USERNAME = 'default'                                            # Usually "default" for Redis Cloud
REDIS_PASSWORD = 'Vwdx5cbcpawpIs5m6QImdHMILpkxbo3y'                  # Replace with your Redis Cloud password
# ============================================================================
